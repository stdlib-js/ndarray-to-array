...
```javascript
ndarray2array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-array@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-array@v0.2.2-umd/browser.js"></script>
```
...
[@stdlib/ndarray/to-json]: https://github.com/stdlib-js/ndarray-to-json/tree/umd
