...
```javascript
import ndarray2array from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-array@v0.2.2-deno/mod.js';
```
...
[@stdlib/ndarray/to-json]: https://github.com/stdlib-js/ndarray-to-json/tree/deno
